    ...
    <section className="page">
      <article className="hero-card">
        ...
        <p className="hero-card__copy">
          Данные поездок демонстрационные. Статусы категорий показывают предполагаемый сценарий
          планирования и пока не синхронизируются и не подтверждаются другими участниками.
        </p>
      </article>
